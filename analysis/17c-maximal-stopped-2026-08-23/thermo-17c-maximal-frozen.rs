...
fn run() -> Result<(), String> {
    ...
    let complete = options.max_eligible.is_none()
        ...
        && !stopped;
    let summary = format!(
        "{{\"type\":\"summary\",\"complete\":{complete},\"records\":{},\"eligible_records\":{eligible_records},\"mandatory_nodes\":{},\"mandatory_degree_prunes\":{},\"mandatory_spatial_prunes\":{},\"isolate_prunes\":{},\"reversal_prunes\":{},\"skeletons\":{},\"merge_nodes\":{},\"merge_spatial_prunes\":{},\"merge_structure_prunes\":{},\"noncanonical_prunes\":{},\"maximal_covers\":{},\"classified_layout_occurrences\":{},\"cut_screened_layouts\":{},\"solver_calls\":{},\"cut_cache_probes\":{},\"witness_cuts_retained\":{},\"witness_cuts_admitted\":{},\"multiple_layouts\":{},\"unique_layouts\":{}}}",
        puzzles.len(),
        totals.mandatory_nodes,
    ...
    F: FnMut(Cover) -> bool,
{
    ...
    fn mandatory_dfs(
        ...
        for digit in 0..SIDE {
            ...
            // Reversing the global symbol order and every selected arc is a
            // fixed-point-free involution.  Enforce its canonical endpoint
            // orientation before trying the expensive final physical edge.
            if depth == SIDE - 1 && digit as u8 <= digit_order[0] {
